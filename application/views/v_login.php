<!doctype html>
    ...
    <head>
        ...
        <meta name="author" content="Klinik Sederhana">
        <meta name="generator" content="Kelompok 2">
...
<form class="form-signin" method="post" action="<?= base_url('auth/login_aksi'); ?>">
    <img class="mb-4" src="<?= base_url(); ?>assets/img/logo.jpg" alt="" width="72" height="72">
    ...
    <p class="mt-5 mb-3 text-muted">&copy; 2021 - Kelompok 2</p>
</form>
</body>
</html>