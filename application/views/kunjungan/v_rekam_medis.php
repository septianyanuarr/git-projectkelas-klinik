<section class="konten mt-2">
    <div class="container fluid">
        ...
        <div class="card-border bg-info text-white">
        Riwayat Berobat
        </div>
        <div class="card-body">
		...
		<table class="table table-stiiped table-sm">
		<thead>
		<tr>
		<th>NO.</th>
		<th>Nama Obat</th>
		...
		<td><?= $r['nama_obat']; ?></td>
		<td>
		<a href="<?= base_url().'kunjungan/hapus_resep/'.$r['id_resep'].'/'.$r['id_berobat'];?>"class="text-danger">Hapus Resep</a>
		</td>
		</tr>
		<?php $no++; } ?>
		</tbody>
