<!doctype html>
    ...
    <head>
		...
		<a class="btn btn-primary" href="<?php echo base_url('pasien/print')?>"><i class="fa fa-print"></i>Print</a>
		<a class="btn btn-danger" href="<?php echo base_url('pasien/pdf')?>"><i class="fa fa-file"></i>Export PDF</a>
		<a class="btn btn-warning" href="<?php echo base_url('pasien/excel')?>"><i class="fa fa-file"></i>EXCEL</a>
